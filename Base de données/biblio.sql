...
-- PHP Version: 5.5.12
drop database if exists biblio22; 
create database biblio22; 
use biblio22; 
...
(1, 'Naruto', 'Manga', 'Shonen Jump', 1, 'ouvrages\\Naruto.jpg', 'Manga etage 7 Num 1', 'Naruto, orphelin, rêve de devenir Hokage pour être reconnu malgré le démon renard scellé en lui.'),
(2, 'L''alchimiste', 'Roman', 'J''ai lu', 1, 'ouvrages\\L''alchimiste.jpg', 'Roman etage 13 Num 1', 'Santiago, un berger espagnol, découvre sa légende personnelle en voyageant jusqu''aux Pyramides.'),
(3, 'Onze minutes', 'Roman', 'J''ai lu', 1, 'ouvrages\\11min.jpg', 'Roman etage 13 Num 2', 'L''histoire d''une jeune fille brésilienne qui tombe dans la prostitution à l''étranger.'),
(4, 'L''étranger', 'Roman', 'Gallimard', 0, 'ouvrages\\L''etranger.jpg', 'Roman etage 13 Num 3', 'Meursault, un homme en Algérie, découvre l''absurdité de la vie lors de son procès.'),
(5, 'Dragon Ball 21', 'Manga', 'Glenat', 1, 'ouvrages\\Dragon_ball.jpg', 'Manga etage 7 Num 2', 'Son Goku cherche les Dragon Balls et affronte des ennemis de plus en plus puissants.'),
(6, 'Un marocain à New York', 'Roman', 'EDDIF', 0, 'ouvrages\\Un_Marocain_a_New_York.jpg', 'Roman etage 13 Num 4', 'Le narrateur explore un New York plein d''humour et de situations décalées.'),
(7, 'One Piece 57', 'Manga', 'Shonen Jump', 0, 'ouvrages\\One_piece.jpg', 'Manga etage 7 Num 3', 'Luffy et son équipage cherchent le One Piece pour devenir roi des pirates.'),
(8, 'Aleph', 'Roman', 'J''ai lu', 0, 'ouvrages\\Aleph.jpg', 'Roman etage 13 Num 8', 'Coelho explore son voyage intérieur et sa rencontre avec Hilal.'),
(9, 'Bleach 13', 'Manga', 'Jump Comics', 1, 'ouvrages\\Bleach.jpg', 'Manga etage 7 Num 4', 'Ichigo, un lycéen, voit les esprits et rencontre une shinigami qui bouleverse sa vie.'),
(10, 'Astérix en Corse', 'Bandes dessinées', 'Casterman', 0, 'ouvrages\\Asterix.jpg', 'Dessinees etage 2 Num 2', 'Astérix déjoue les plans de César pour défendre son village de Gaule.'),
(11, 'Le Petit Prince', 'Roman', 'Folio Junior', 0, 'ouvrages\\Le_petit_prince.jpg', 'Roman etage 13 Num 7', 'Un aviateur rencontre un enfant venu d''une autre planète dans le désert.'),
...
(13, 'La découverte de l''Amérique', 'Histoire', 'Bouhaddioui', 0, 'ouvrages\\La_decouverte_de_l''amerique.jpg', 'Historique etage 2 Num 4', 'Aucune Information'),
(14, 'Chimie organique Les grands principes', 'Sciences appliquées', 'DUNOD', 0, 'ouvrages\\Chimie_organique.jpg', 'Science etage 13 Num 1', 'Aucune Information'),
...
(16, 'Le beau livre de la physique', 'Sciences appliquées', 'DUNOD', 0, 'ouvrages\\Physique.jpg', 'Science etage 13 Num 1', 'Aucune Information'),
(17, 'Apologie de Socrate', 'Philosophie', 'GF Flammarion', 0, 'ouvrages\\Apologie_de_socrate.jpg', 'Philosophie etage 9 Num 3', 'Socrate défend sa philosophie lors de son procès à Athènes.'),
(18, 'Durée et simultanéité', 'Philosophie', 'PUF', 0, 'ouvrages\\Duree_et_simultaneite.jpg', 'Philosophie etage 9 Num 3', 'Aucune Information'),
(19, 'Anthropologie naïve Anthropologie savante', 'Sciences sociales', 'Empreintes de l''Homme', 0, 'ouvrages\\Anthropologie_naive_savante.jpg', 'Science etage 13 Num 1', 'Aucune Information'),
(20, 'L''économie POUR LES NULS', 'Économie', 'Glenat', 0, 'ouvrages\\L''economie_pour_les_nuls.jpg', 'Science etage 13 Num 3', 'Aucune Information'),
(21, 'Mon Combat', 'Histoire', 'Bouhaddioui', 0, 'ouvrages\\Mon_combat.jpg', 'Historique etage 4 Num 4', 'Le manifeste politique de Hitler avec ses ambitions expansionnistes et raciales.'),
...
(23, 'Anthropologie 1-Culture et personnalité', 'Sciences sociales', 'Les éditions de Minuit', 0, 'ouvrages\\Anthropologie_culture_personnalite.jpg', 'Science etage 13 Num 1', 'Aucune Information'),
(24, 'L''étourdi ou les contretemps', 'Art', 'Classique', 0, 'ouvrages\\L''etourdi_ou_les_contretemps.jpg', 'Art etage 1 Num 1', 'Aucune Information'),
...
(28, 'Antigone', 'Roman', 'La Table Ronde', 0, 'ouvrages\\Antigone.jpg', 'Roman etage 13 Num 6', 'Jean Anouilh réécrit le mythe d''Antigone en résonance avec la guerre.'),
(29, 'Ainsi parlait Zarathoustra', 'Philosophie', 'A.H.E', 0, 'ouvrages\\Ainsi_parlait_zarathoustra.jpg', 'Philosophie etage 9 Num 6', 'Le texte philosophique de Nietzsche sur la religion et la moralité.'),
(30, 'Dom Juan', 'Art', 'Classiques Larousse', 1, 'ouvrages\\Dom_juan.jpg', 'Art etage 1 Num 2', 'Le Festin de Pierre, une comédie sur le célèbre séducteur.'),
(31, 'Le dernier jour d''un condamné', 'Roman', 'folio classique', 0, 'ouvrages\\Le_dernier_jour_d''un_condamne.jpg', 'Roman etage 13 Num 5', 'Le roman se présente comme le journal qu''un condamné à mort écrit durant les vingt-quatre '),
(32, 'Hunter X Hunter 17', 'Manga', 'Kana', 1, 'ouvrages\\HunterxHunter.jpg', 'Mange etage 7 Num 5', 'Gon Freecss a douze ans, et rêve de devenir hunter (chasseur en anglais). Les hunters sont des aventuriers d''élite qui peuvent être chasseurs de prime, chefs-cuisinier, archéologues, zoologues,'),
(33, 'Lucky Luke La légende de l''ouest', 'Bandesdessinees', 'Lucky comics', 0, 'ouvrages\\Lucky_Luke.jpg', 'Dessinees etage 2 NUM 3', 'La série met en scène le personnage de Lucky Luke, connu pour être « L''homme qui tire plus vite que son ombre », accompagné de son cheval Jolly Jumper.'),
...
(39, 'Tintin en Amérique', 'Bandesdessinees', 'casterman', 0, 'ouvrages\\Tintin.jpg', 'Dessinees etage 2 NUM 1', 'Le héros de la série est le personnage éponyme, Tintin, un jeune reporter et globe-trotter belge. Il est accompagné dans ses aventures par son fox-terrier Milou.'),
...
(41, 'Titeuf 9', 'Bandesdessinees', 'Glenat', 0, 'ouvrages\\Titeuf.jpg', 'Dessinees etage 2 NUM 4', 'La série raconte la vie quotidienne de Titeuf, un enfant semblerait-il âgé de huit ou dix ans');
