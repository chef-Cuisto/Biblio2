  ...
  <div id="reglement_ecrire">
	<h2>Regles de prêt</h2>
		<ul>
			...
			<li>Tout retard sera sanctionné par une amende (2€/jour).</li>
			<li>Tout document perdu ou abimé devra être remplacé ou remboursé.</li>
		</ul>

	<h2>Modalité de prêt</h2>
		<ul>
			<li>Pour toute opération de prêt, les clients sont tenus de déposer leur carte de d’étudiant au guichet de prêt.</li>
