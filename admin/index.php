...
<div class="foo">
    ...
    <div class="col-lg-4">
      <div class="propos">
        ...
        <p>Ce site a ete concu dans le cadre scolaire</p>
        <p><br><a href="../index.php">le site</a>
      </div>
    </div>
    <div class="col-lg-4">
      <div class="team">        
        <ul>
          <h2 class="foo-headline"></h2>
          <li><a herf="#">Fortinat Pombi</a></li>
          <li><a herf="#">HAGIL Taymiyya</a></li>
          <li><a herf="#">rajit Niroshanant</a></li>
          <li><a herf="#">Leon Chepper</a></li>
...
<div class="rights" >
  © 2024 copyrights to <span class="italic">Iris</span>
</div>
